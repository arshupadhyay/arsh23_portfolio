...
const Sidebar = () => (
    <div className='nav-bar'>
        ...
        <ul>
            <li>
                <a target='_blank' rel='noreferrer' href='https://www.linkedin.com/in/arsh-upadhyay-701225247'>
                    <FontAwesomeIcon icon={faLinkedin} color='#4d4d4e'/>
                </a>
            </li>

            <li>
                <a target='_blank' rel='noreferrer' href='https://github.com/arshupadhyay'>
